drop schema cm_test cascade;
create schema cm_test;

set search_path=cm_test;
...
CREATE UNIQUE INDEX IDX_PROPERTIES_NAME ON PROPERTIES(NAME,FILE_FK);
...
(
  ...
  PARENT_VERSION INTEGER REFERENCES
          PROPERTIES_VERSION(PROPERTIES_VERSION_PK),
  PRIMARY KEY ( PROPERTIES_VERSION_PK)
) TABLESPACE configurationmanagement;


CREATE INDEX IDX_PROPERTIES_OLD_VALUE ON PROPERTIES_VERSION(OLD_VALUE);
CREATE INDEX IDX_PROPERTIES_NEW_VALUE ON PROPERTIES_VERSION(NEW_VALUE);