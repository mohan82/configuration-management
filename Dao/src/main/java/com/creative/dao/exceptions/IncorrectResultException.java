...
public class IncorrectResultException extends Exception {
    ...
    public IncorrectResultException(String message, Throwable cause) {
    ...
    public IncorrectResultException(Throwable cause) {
        super(cause);    //To change body of overridden methods use File | Settings | File Templates.
    }

    protected IncorrectResultException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
